...
- **Order Information**:  
  Order IDs, quantities ordered, along with dates and times—ideal for time-series analysis of sales activities.

- **Pricing Data**:  
  Unit prices and total prices for every pizza order, which can support revenue analysis and pricing strategy evaluation.

🔍 Curious about Pizza Topia's dataset? Explore the complete sales data here: [Pizza Topia Dataset](2_pizza_topia_sales.csv)
